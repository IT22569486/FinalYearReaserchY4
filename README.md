...
| ML Framework | PyTorch + Ultralytics | Object detection |
| Depth Estimation | ONNX Runtime + MiDaS | Distance measurement |
...
| Model | Type | Purpose |
|-------|------|---------|
| YOLOv8 Segmentation | Computer Vision | Lane detection |
| YOLOv8 Detection | Computer Vision | Road object detection |
| MiDaS | Depth Estimation | Distance measurement |
| LightGBM | Regression | Safe speed prediction |
...
# Edit device_config.json with your device details
...
```json
{
  ...
  "bus_number": "NB-1234",
  "mqtt_host": "your-backend-server.com",
  "mqtt_port": 1883
}
```
