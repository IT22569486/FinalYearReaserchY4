      ...
      setMapData(prev => {
        ...
        if (index >= 0) {
          ...
          newData[index] = { 
            ...
            passenger_count: updatedBus.passenger_count ?? updatedBus.total_passenger_count ?? newData[index].passenger_count,
            occupancy: updatedBus.passenger_count ?? updatedBus.total_passenger_count ?? newData[index].occupancy,
        ...
        return [...prev, { 
          ...
          location: updatedBus.location || { lat: updatedBus.latitude, lng: updatedBus.longitude },
          speed: updatedBus.speed,
          passenger_count: updatedBus.passenger_count ?? updatedBus.total_passenger_count ?? 0,
          occupancy: updatedBus.passenger_count ?? updatedBus.total_passenger_count ?? 0,
          route_name: updatedBus.route_name,
          route_id: updatedBus.route_id,
          status: 'online',
          last_updated: updatedBus.timestamp
